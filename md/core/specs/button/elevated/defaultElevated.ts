...
export const defaultButtonElevatedSpecs = (props: ButtonPropsType) => {
  ...
  const defaultButtonElevated: ElevatedButtonSpecsType = {
    ...
    dark:shadow-elevation-1-dark
    shadow-shadow-light/[.20]
    dark:shadow-shadow-dark/[.20]

    bg-surface-light
    dark:bg-surface-dark
    after:absolute
    after:inset-0
    after:bg-surface-tint-light
    dark:after:bg-surface-tint-dark
    after:opacity-5
    ...
    hover:shadow-elevation-2-light
    dark:hover:shadow-elevation-2-dark

    focus:after:opacity-state-focus
    focus:shadow-elevation-1-light
    dark:focus:shadow-elevation-1-dark

    active:after:opacity-20
    active:shadow-elevation-1-light
    dark:active:shadow-elevation-1-dark
    `),
